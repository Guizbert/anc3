...
public class MenuViewModel {
    ...
    public ReadOnlyStringProperty stopLabelProperty() {
    ...
    public ReadOnlyIntegerProperty score() {
        return fermeFacade.scoreProperty();
    }

    public ReadOnlyIntegerProperty graine() {
        return fermeFacade.graineProperty();
    }
